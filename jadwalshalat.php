...
#float-left{position:fixed;_position:absolute;top:0px;float:left; margin-left:0px;z-index:10;
...
.hurup{font-size:<?=$isi[1];?>;}
		...
		<div id="float-left"><img src="bg/<?=$logoku[0];?>" width="<?=$isi1[1];?>" /></div>
			<div id="trik_atas"><?php include "tampilow2.php";?></div>
...
navigator.geolocation.getCurrentPosition((loc) => {
    ...
    $.ajax({
        ...
        success: function(data){
            $('#upcomingPrayer').html('Waktu shalat mendatang di '+'<strong>'+ data.results[1].address_components[4].long_name+','+ data.results[0].address_components[7].long_name +'</strong>');
...
//console.log(month);
$('.tanggal').html(thisDay +',' + ' ' + day + ' ' + month + ' ' + year);</script></body></html>