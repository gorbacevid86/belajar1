...
<head>
    <title>Tema 2 Display Masjid by Zanuar Didik Bintoro</title>
...
<video width="<?=$tw[0];?>" autoplay class="embed-responsive-item">
...
Your browser does not support the video tag.
        ...
        <div class="col-4 p-0 m-0 p-r-10">
           <div style="height:100px;" class="bg-blue text-center"><?php include "ubahlogo.php";?></div>
           <div style="height:390px" class=" embed-responsive m-t-15"><?php include "slider.php";?></div>
           <?php
