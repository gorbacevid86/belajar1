<?php
include "../koneksi.php";
$qbg=mysqli_query($koneksi,"select warna from warnabg where id=5");
...
<div class="box box-success box-solid">
 <div class="box-header with-border">
              <h3 class="box-title">Logo Kanan Sekarang</h3>
            ...
            <!-- /.box-header -->
            <div class="box-body">
            Gambar logo Kanan sekarang (<?php echo "$bg[0] "; echo "ukuran: $lebar x $tinggi pixel";?>) :<br><br>
<img src="../bg/<?=$bg[0];?>" width="400">
	</div></div>

<form action="index.php?menu=ubahlogokanan.php&aksi=kirim" method="post" enctype="multipart/form-data" name="gbr" >
    ...
    <input type="submit" value="Ubah Logo (kanan)" name="submit" class="btn btn-primary">
...
$ekstensi_diperbolehkan	= array('png','jpg', 'jpeg','gif','bmp');
 ...
 $query=mysqli_query($koneksi,"update warnabg set warna='$nama' where id=5");
 if($query){
	 echo "Gambar berhasil diinput....silahkan menunggu";
						echo("<meta http-equiv=\"refresh\" content=\"1;url=index.php?menu=ubahlogokanan.php\">");
