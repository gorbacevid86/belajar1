...
#	2016-02-23 21:30:57 - bugfix, mysql_connect halted execution upon invalid credentials
...
#	2016-02-24 00:12:41 - bugfix, mysql_db_query - selected database could be bypassed
#	2016-02-24 00:38:04 - bugfix, mysql_fetch_field - null when invalid parameters
#	2016-02-24 01:02:44 - bugfix, mysql_fetch_lengths - null when invalid parameters
#	2016-02-24 02:17:27 - bugfix, mysql_field_flags returned invalid value, adding mysql_field_bitflags_to_flags
#	2016-02-24 02:35:15 - bugfix, mysql_field_seek - null when invalid parameters
#	2016-02-24 02:55:09 - bugfix, mysql_field_type - returned invalid value, adding mysql_field_bittypes_to_types
#	2016-02-24 03:40:26 - bugfix, mysql_get_client_info, adding link argument
#	2016-02-24 03:43:55 - bugfix, mysql_get_host_info - null when invalid parameters
#	2016-02-24 04:10:19 - bugfix, mysql_get_proto_info - null when invalid parameters
#	2016-02-24 04:25:01 - bugfix, mysql_get_server_info - null when invalid parameters
#	2016-02-24 15:13:31 - bugfix, mysql_affected_rows - invalid value when invalid parameters
...
#	2016-02-24 19:21:21 - bugfix, mysql_num_fields - null when invalid parameters
...
if (!extension_loaded('mysql')) {
	...
	function mysql_create_db($database_name, $link_identifier = NULL) {
		...
		return mysqli_query($koneksi,'CREATE DATABASE '.mysql_real_escape_string($database_name), $link_identifier);
	}
	...
	function mysql_db_name($result , $row, $field = NULL) {
		# return mysqli_query($koneksi,'SELECT DATABASE()', mysql_ensure_link($link_identifier));
	...
	function mysql_db_query($database, $query, $link_identifier = NULL) {
		...
		return mysqli_query($koneksi,$query, $link_identifier);
	}
	...
	function mysql_drop_db($database_name, $link_identifier = NULL) {
		...
		return mysqli_query($koneksi,'DROP DATABASE '.mysql_real_escape_string($database_name), $link_identifier);
	}
	...
	function mysqli_fetch_assoc ($result) {
		# mysqli_fetch_assoc = returns FALSE if there are no more rows
	...
	function mysqli_fetch_row ($result) {
		...
		# mysqli_fetch_row = FALSE if there are no more rows
	...
	function mysql_list_dbs ($link_identifier = NULL) {
		...
		$temp = mysqli_query($koneksi,'SHOW DATABASES', mysql_ensure_link($link_identifier));
	...
	function mysql_list_fields ($database_name, $table_name, $link_identifier = NULL) {
		...
		return mysqli_query($koneksi,'SHOW COLUMNS FROM '.mysql_real_escape_string($database_name).'.`'.mysql_real_escape_string($table_name).'`', mysql_ensure_link($link_identifier));
	}
	...
	function mysql_list_processes($link_identifier = NULL) {
		...
		$temp = mysqli_query($koneksi,"SHOW PROCESSLIST", mysql_ensure_link($link_identifier));
		if ($temp === null) {
			return false;
		}
		return $temp;
	...
	function mysql_list_tables ($database_name, $table_name, $link_identifier = NULL) {
		...
		return mysqli_query($koneksi,'SHOW TABLES FROM '.mysql_real_escape_string($database_name), mysql_ensure_link($link_identifier));
	}
