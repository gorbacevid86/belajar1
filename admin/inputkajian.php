<?php session_start();
include "../koneksi.php";
$cari=mysqli_query($koneksi,"select * from pengumuman where id=7");
...
<form action="index.php?menu=inputkajian.php&aksi=kirim" method="post" enctype="multipart/form-data" name="frm1">
...
<?php
if($_GET['aksi']=="kirim"){
	$input=mysqli_query($koneksi,"update pengumuman set pengumuman='$_POST[isi]' where id=7");
	if($input) //header("location:index.php?menu=inputpeng.php");
	echo("<meta http-equiv=\"refresh\" content=\"1;url=index.php?menu=inputkajian.php\">");
	else echo "gagal";
}
